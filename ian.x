                ...
                if getgenv().loltoggle then
                    ...
                    if Locking then
                        ...
                        if getgenv().Notificationmode then
                            x("ian", "" .. Plr.Character.Humanoid.DisplayName, 3)
                        end
                ...
                elseif tonumber(ping) <= 40 then
                    ...
                    elseif tonumber(ping) <= 50 then
                        ...
                        elseif tonumber(ping) >= 200 then
                            notif("ian", "your ping is above to 200 so settings might not be accurate", 3)
...
local lib = library:Load({name = "Ian X", sizeX = 378, sizeY = 498, color = Color3.fromRGB(255, 20, 88)})
